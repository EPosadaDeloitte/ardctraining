...
public class CustomProductLabelLabel implements LabelProvider<CustomProductLabelModel> {
    ...
    @Override
    public String getLabel(CustomProductLabelModel customProductLabelModel) {
        final String customer = Objects.nonNull(customProductLabelModel.getCustomer()) ?
                customProductLabelModel.getCustomer().getUid()
                :
                ALL_WILDCARD;
        return new StringBuilder()
                .append(customProductLabelModel.getProduct().getCode())
                .append(" . ")
                .append(customer)
                .append(" . ")
                .append(customProductLabelModel.getLabel())
                .toString();
    }

    @Override
    public String getShortLabel(CustomProductLabelModel object) {
        return LabelProvider.super.getShortLabel(object);
    }
